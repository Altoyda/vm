...
then
    if ! curl -sfL https://raw.githubusercontent.com/Altoyda/vm/master/lib.sh -o /var/scripts/lib.sh
    then
...
then
    curl -sfL https://raw.githubusercontent.com/Altoyda/vm/master/lib.sh -o /var/scripts/lib.sh
fi
